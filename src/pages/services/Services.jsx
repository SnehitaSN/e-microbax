    ...
    <Layout>
      <div className=" mb-10 mt-20">
        <div className="grid grid-cols-2 grid-rows-3 gap-4">
          ...
          {/* section 3 */}
          <div className=" p-4 flex flex-col items-center  justify-center ml-10">
            <div className="">
              <h2 className="text-3xl font-sans text-green-700 font-semibold mt-4">
                Quality
              </h2>
          ...
          <div className=" p-4 flex flex-col items-center justify-center ">
            <div className="text-left -mt-6 ">
              <h2 className="text-3xl text-green-700 mb-2  -mt-10 font-sans font-semibold">
                Private Labelling
              </h2>
              <p className="mt-4 text-xl font-sans mr-10 ">
              ...
              <br />
              <span className="mt-4 text-xl font-sans mr-10 font-semibold text-green-900 hover:text-bold hover:text-green-900 hover:text-2xl">
